...
describe.skip("🦹 Economic Attack Simulations", function () {
  ...
  describe.skip("💰 Oracle Manipulation Attacks", function () {
    ...
    it("Devrait détecter les écarts de prix anormaux", async function () {
      ...
      await expect(
        oracleAggregator.setPriceForSymbol("ETH-USD", manipulatedPrice)
      ).to.be.revertedWith("Price deviation too high");
    });
  });
  
  describe.skip("⚡ Flash Loan Attacks", function () {
  ...
  describe.skip("😈 Griefing Attacks", function () {
  ...
  describe.skip("🏦 Bank Run Simulation", function () {
  ...
  describe.skip("🎯 Targeted Attacks", function () {
