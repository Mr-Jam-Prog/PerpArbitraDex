...
contract MockAMMPool is IAMMPool {
    ...
    function calculateFundingPayment(uint256, uint256, bool, int256) external view override returns (int256) { return 0; }
    function getCumulativeFundingIndex(uint256) external view override returns (int256) { return 0; }
